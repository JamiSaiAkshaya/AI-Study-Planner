...
public final class ActivityAllTasksBinding implements ViewBinding {
  ...
  private ActivityAllTasksBinding(@NonNull CoordinatorLayout rootView,
  ...
  public static ActivityAllTasksBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAllTasksBinding((CoordinatorLayout) rootView, fabAddTask, progressBar,
